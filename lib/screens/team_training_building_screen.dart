...
class TeamTrainingAndBuildingScreen extends StatelessWidget {
  ...
  void _addOnboardingTemplate(BuildContext context) async {
    final template = [
      TrainingActivity(
          title: 'Welcome Message & Introduction',
          category: 'Onboarding',
          isMandatory: true,
          duration: '30 mins'),
      TrainingActivity(
          ...
          duration: '1 hour'),
      TrainingActivity(
          title: 'Roles & Responsibilities Review',
          category: 'Onboarding',
          isMandatory: true,
          duration: '45 mins'),
      TrainingActivity(
          title: 'Meeting Cadence & Communication Channels',
          category: 'Onboarding',
          isMandatory: true,
          duration: '30 mins'),
    ];
    ...
    final existing = provider.projectData.trainingActivities;
    final retained = existing.where((a) => a.category != 'Onboarding').toList();
