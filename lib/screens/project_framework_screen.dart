                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const PlanningAiNotesCard(
                        ...
                        checkpoint: 'project_framework',
                        description:
                            'Capture relevant notes on Project Details.',
                      ),
                      ...
                      _MobileProjectInfoSection(
                        ...
                        isNameAiGenerated:
                            _fieldIsAiGenerated['project_name'] ?? false,
                        isObjectiveAiGenerated:
                            _fieldIsAiGenerated['project_objective'] ?? false,
                        ...
                        onRegenerateObjective: () =>
                            _regenerateProjectObjective(),
                        onUndoName: () =>
                            _undoField('project_name', _projectNameController),
                        onRedoName: () =>
                            _redoField('project_name', _projectNameController),
                        onUndoObjective: () => _undoField(
                            'project_objective', _projectObjectiveController),
                        onRedoObjective: () => _redoField(
                            'project_objective', _projectObjectiveController),
                      ),
                      const SizedBox(height: 24),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _MobileProjectInfoSection(
                                  ...
                                  onBeforeUndo: _saveData,
                                  isNameAiGenerated:
                                      _fieldIsAiGenerated['project_name'] ??
                                          false,
                                  isObjectiveAiGenerated: _fieldIsAiGenerated[
                                          'project_objective'] ??
                                      false,
                                  isRegeneratingName: _isRegeneratingName,
                                  isRegeneratingObjective:
                                      _isRegeneratingObjective,
                                  canUndoName: _canUndoField('project_name'),
                                  canRedoName: _canRedoField('project_name'),
                                  canUndoObjective:
                                      _canUndoField('project_objective'),
                                  canRedoObjective:
                                      _canRedoField('project_objective'),
                                  onRegenerateName: () =>
                                      _regenerateProjectName(),
                                  onRegenerateObjective: () =>
                                      _regenerateProjectObjective(),
                                  onUndoName: () => _undoField(
                                      'project_name', _projectNameController),
                                  onRedoName: () => _redoField(
                                      'project_name', _projectNameController),
                                  onUndoObjective: () => _undoField(
                                      'project_objective',
                                      _projectObjectiveController),
  ...
  Future<void> _exportPdf() async {
    ...
    await PdfExportHelper.exportScreenPdf(
      ...
      sections: [
        ...
        PdfSection.text(
            'Notes',
            projectData.planningNotes['planning_project_framework_notes'] ??
                'No data recorded.'),
      ],
    );
  }
            ...
            child: const Row(
              children: [
                ...
                Icon(Icons.chevron_right,
                    size: 14, color: _Tokens.outlineVariant),
                SizedBox(width: 4),
                Text(
                  'Project Details',
                  style: TextStyle(
            ...
            Expanded(
              ...
              child: ElevatedButton.icon(
                ...
                icon: const Icon(Icons.arrow_forward,
                    size: 18, color: _Tokens.primaryOn),
                label: Text(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      _ToolbarIconButton(icon: Icons.format_bold, onTap: () {}),
                      _ToolbarIconButton(
                ...
                Focus(
                  ...
                  child: VoiceTextField(
                    ...
                    minLines: 5,
                    decoration: InputDecoration(
                      hintText: 'What is the main objective of this project?',
                    ...
                    style: const TextStyle(
                        fontSize: 13, color: _Tokens.onSurface, height: 1.5),
                  ),
                ),
              ],
            ),
...
class _FrameworkRadioCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final borderColor = isSelected ? _Tokens.primary : _Tokens.outlineVariant;
    return Material(
      color: _Tokens.surfaceBright,
      borderRadius: BorderRadius.circular(10),
      child: InkWell(
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: isSelected ? _Tokens.primary : _Tokens.surfaceBright,
                  border: Border.all(
                    color:
        ...
        children: [
          ...
          HoverableFieldControls(
            ...
            child: VoiceTextField(
              ...
              style: const TextStyle(
                  fontSize: 13, color: _Tokens.onSurface, height: 1.4),
            ),
          ),
        ],
      ),
