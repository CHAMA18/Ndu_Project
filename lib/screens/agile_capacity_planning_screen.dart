...
class _AgileCapacityPlanningScreenState
  ...
  double get _focusFactor {
    ...
    return (_availability / 100) * (1 - overheadFraction) * (1 - bufferFraction);
  }
        ...
        children: [
          const Text('Capacity Parameters',
              style: TextStyle(
                  ...
                  color: _kHeadline)),
          const SizedBox(height: 16),
          _buildSliderField('Working days per week', _workingDays.toDouble(),
              4, 6, 1, (v) {
          ...
          const SizedBox(height: 12),
          _buildSliderField('Meeting overhead (hrs/week)', _meetingOverhead, 0,
              20, 1, (v) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (_leaveEntries.isEmpty)
            ...
            ..._leaveEntries.asMap().entries.map((e) =>
                _buildLeaveRow(e.key, e.value)),
        ],
      ),
    );
  }
        ...
        children: [
          SizedBox(
            ...
            child: VoiceTextField(
              controller: _leavePersonCtrls[entry.id] ??
        ...
        children: [
          ...
          if (_holidays.isEmpty)
            ...
            ..._holidays.asMap().entries.map(
                (e) => _buildHolidayRow(e.key, e.value)),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          SizedBox(
            width: 180,
            child: VoiceTextField(
              controller: _holidayNameCtrls[entry.id] ??
                  TextEditingController(),
              decoration: const InputDecoration(
      ...
      sections: [
        ...
        PdfSection.text('Notes',
            projectData.planningNotes[
                    'planning_agile_capacity_planning_notes'] ??
                'No data recorded.'),
      ],
    );
  }
