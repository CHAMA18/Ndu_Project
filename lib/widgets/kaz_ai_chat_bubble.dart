...
class _KazAiChatPopupState extends State<_KazAiChatPopup>
  ...
  Future<String> _getAiResponse(String userMessage) async {
    if (!OpenAiConfig.isConfigured) {
      return 'Please configure your AI API key in **Settings** to enable KAZ AI. I\'ll be ready to help once the connection is established.';
    }
    ...
    try {
      ...
      if (response.statusCode == 401) {
        return 'Invalid API key. Please check your AI configuration in **Settings**.';
      }
      if (response.statusCode == 429) {
        return 'API quota exceeded. Please check your billing or try again shortly.';
      }
