...
class SecureAPIConfig {
  ...
  // Using Claude 3.5 Sonnet (latest alias) — Anthropic's balanced model
  // with strong reasoning and speed. The 'latest' alias automatically
  // resolves to the most recent stable version.
  ...
  // When a user provides their own Anthropic API key via
  // Settings > Integrations, direct client-side access is used for
  // minimum latency.
  ...
  /// before giving up. Uses specific dated versions for reliability.
  ...
  /// Default timeout for AI API requests (30 seconds for Claude models
  /// which may take longer to generate detailed responses).
